<footer class="fixed bottom-6 animate-footer-slide-up-fade">
    <div class="flex items-end gap-4">
        <a
            aria-label="GitHub"
            class="text-slate-11 transition duration-200 ease-in-out hover:text-slate-12"
            target="_blank"
            href="https://github.com/resendlabs"
            ><svg
                width="20"
                height="24"
                viewBox="0 0 24 24"
        ...
        ><a
            ...
            target="_blank"
            class="text-slate-11 transition duration-200 ease-in-out hover:text-slate-12"
            href="https://twitter.com/resendlabs"
            ><svg
                width="20"
                height="24"
                viewBox="0 0 24 24"
        ...
        ><a
            ...
            target="_blank"
            class="text-slate-11 transition duration-200 ease-in-out hover:text-slate-12"
            href="https://linkedin.com/company/resend"
            ><svg
                width="20"
                height="24"
                viewBox="0 0 24 24"
                ...
                aria-hidden="true"
                ><path
                    d="M5.58648 7.72107H0.768444C0.554612 7.72107 0.381348 7.89441 0.381348 8.10817V23.5865C0.381348 23.8003 0.554612 23.9736 0.768444 23.9736H5.58648C5.80032 23.9736 5.97358 23.8003 5.97358 23.5865V8.10817C5.97358 7.89441 5.80032 7.72107 5.58648 7.72107Z"
                    fill="rgb(100 116 139)"
                /><path
                    d="M3.1793 0.0264282C1.42622 0.0264282 0 1.4511 0 3.20225C0 4.95417 1.42622 6.37938 3.1793 6.37938C4.93099 6.37938 6.35605 4.95409 6.35605 3.20225C6.35613 1.4511 4.93099 0.0264282 3.1793 0.0264282Z"
                    fill="rgb(100 116 139)"
                /><path
                    d="M17.8417 7.33636C15.9066 7.33636 14.4762 8.16824 13.6085 9.11345V8.10816C13.6085 7.8944 13.4353 7.72106 13.2214 7.72106H8.60731C8.39348 7.72106 8.22021 7.8944 8.22021 8.10816V23.5865C8.22021 23.8003 8.39348 23.9735 8.60731 23.9735H13.4148C13.6287 23.9735 13.8019 23.8003 13.8019 23.5865V15.9283C13.8019 13.3477 14.5029 12.3423 16.3018 12.3423C18.261 12.3423 18.4167 13.954 18.4167 16.0611V23.5865C18.4167 23.8004 18.5899 23.9736 18.8038 23.9736H23.613C23.8269 23.9736 24.0001 23.8004 24.0001 23.5865V15.0964C24.0001 11.2591 23.2684 7.33636 17.8417 7.33636Z"
                    fill="rgb(100 116 139)"
                /></svg
            ></a
        >
